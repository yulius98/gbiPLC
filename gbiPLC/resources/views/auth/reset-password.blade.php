...
<x-layout>
    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div>
                <button type="submit" class="flex w-full justify-center rounded-md bg-blue-700 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-blue-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#723322]">Reset Password</button>
            </div>
            </form>
