                    ...
                    <div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                @if ($filename && $filename instanceof \Illuminate\Http\UploadedFile)
                                    @php
                                        try {
                                            ...
                                            // Log ke Laravel log
                                            \Log::info('Carousel - Temporary URL Generated', [
                                                'url' => $tempUrl,
                                            ...
                                            \Log::error('Carousel - Failed to generate preview', [
                                                'error' => $e->getMessage(),
                                                'filename' => $filename->getClientOriginalName()
                                            ]);
                                            $tempUrl = null;
                                    ...
                                    @if($dataUri)
                                        <div class="mt-3 border p-2 rounded">
                                            ...
                                            <img src="{{ $dataUri }}"
                                                 id="preview-img-carousel-{{ md5($filename->getClientOriginalName()) }}"
                                                 alt="Preview Gambar"
                                                 class="img-thumbnail object-contain rounded d-block mb-2"
                                                 style="max-height: 150px;"
                                                 onload="document.getElementById('img-success-carousel-{{ md5($filename->getClientOriginalName()) }}').style.display='block';">

                                            <!--
                                            <div id="img-success-carousel-{{ md5($filename->getClientOriginalName()) }}" class="alert alert-success mb-2" style="display:none;">
