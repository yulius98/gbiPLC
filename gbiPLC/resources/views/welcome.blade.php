...
<x-layout>
    ...
    <!-- Jemaat Ultah -->
    @auth
        <section id="birthday" class="py-24 shadow-lg shadow-gray-500" style="margin-top:40px; border-radius: 16px; background: rgba(255, 255, 255, 0.2); backdrop-filter: blur(3px);">
