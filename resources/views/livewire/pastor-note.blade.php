                                ...
                                <div class="col-sm-9">
                                    ...
                                    @isset($filename)
                                        @if ($filename instanceof \Illuminate\Http\UploadedFile)
                                            ...
                                            <div class="mt-3">
                                                @if($dataUri)
                                                    <div class="border p-2 rounded">
                                                        ...
                                                        <img src="{{ $dataUri }}" 
                                                             id="preview-img-{{ md5($filename->getClientOriginalName()) }}"
                                                             alt="Preview Gambar" 
                                                             class="img-thumbnail object-contain rounded d-block mb-2" 
                                                             style="max-height: 150px;"
                                                             onload="document.getElementById('img-success-{{ md5($filename->getClientOriginalName()) }}').style.display='block';">
                                                        <!--
                                                        <div id="img-success-{{ md5($filename->getClientOriginalName()) }}" class="alert alert-success mb-2" style="display:none;">
                                            ...
                                            <script>
                                                (function() {
                                                    console.log('=== Livewire Image Preview ===');
