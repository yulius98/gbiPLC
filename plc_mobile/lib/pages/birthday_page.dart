...
class _BirthdayPageState extends State<BirthdayPage> {
  late Future<List<Birthday>> _birthdayFuture;

  @override
  void initState() {
    super.initState();
    _birthdayFuture = fetchBirthday();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<Birthday>>(
        future: _birthdayFuture,
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Gambar Header
                      if (birthday.photourl.isNotEmpty)
                        ClipRRect(
