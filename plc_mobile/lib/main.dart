...
class PlcApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const HomePage(),
      routes: {
        '/saat-teduh': (_) => const SaatTeduhPage(),
        '/materi-kotbah': (_) => const MateriKotbahPage(),
        '/birthday': (_) => const BirthdayPage(),
        '/register': (_) => const RegisterPage(),
        '/ibadahraya': (_) => const IbadahRayaPage(),
        '/event': (_) => const EventPage(),
        '/life-group':(_) => const LifeGroupPage(),
        '/loginuser':(_) => const LoginUserPage(),
      },
    );
  }
}
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _buildImageGridItem(
                          ...
                          onTap: () => Navigator.pushNamed(context, '/loginuser'),
                        ),
                      ),
                    ],
                  ),
